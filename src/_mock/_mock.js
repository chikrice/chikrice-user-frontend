...
export const _mock = {
  ...
  // Image
  image: {
    cover: (index) => `${config.assetsApi}/assets/images/cover/cover_${index + 1}.jpg`,
    avatar: (index) => `${config.assetsApi}/assets/images/avatar/avatar_${index + 1}.jpg`,
    travel: (index) => `${config.assetsApi}/assets/images/travel/travel_${index + 1}.jpg`,
    company: (index) => `${config.assetsApi}/assets/images/company/company_${index + 1}.png`,
    product: (index) => `${config.assetsApi}/assets/images/m_product/product_${index + 1}.jpg`,
    portrait: (index) => `${config.assetsApi}/assets/images/portrait/portrait_${index + 1}.jpg`,
  },
};
